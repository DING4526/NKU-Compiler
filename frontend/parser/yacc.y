...
VAR_DECLARATOR:
    ...
    | IDENT ARRAY_DIMENSION_EXPR_LIST ASSIGN LBRACE INITIALIZER_LIST RBRACE {
        Entry* entry = Entry::getEntry($1);
        LeftValExpr* lval = new LeftValExpr(entry, $2, @1.begin.line, @1.begin.column);
        InitializerList* init_list = new InitializerList($5, @5.begin.line, @5.begin.column);
        $$ = new VarDeclarator(lval, init_list, @1.begin.line, @1.begin.column);
    }
    ...
    | IDENT LBRACKET RBRACKET ARRAY_DIMENSION_EXPR_LIST ASSIGN LBRACE INITIALIZER_LIST RBRACE {
        Entry* entry = Entry::getEntry($1);
        $4->insert($4->begin(), new LiteralExpr(-1, @2.begin.line, @2.begin.column));
        LeftValExpr* lval = new LeftValExpr(entry, $4, @1.begin.line, @1.begin.column);
        InitializerList* init_list = new InitializerList($7, @7.begin.line, @7.begin.column);
        $$ = new VarDeclarator(lval, init_list, @1.begin.line, @1.begin.column);
    }
    ;
...
ASSIGN_EXPR:
    ...
    LEFT_VAL_EXPR ASSIGN NOCOMMA_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::ASSIGN, $1, $3, @1.begin.line, @1.begin.column);
    }
    ;
...
LOGICAL_OR_EXPR:
    ...
    | LOGICAL_OR_EXPR OR LOGICAL_AND_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::OR, $1, $3, @1.begin.line, @1.begin.column);
    }
    ;
...
LOGICAL_AND_EXPR:
    ...
    | LOGICAL_AND_EXPR AND EQUALITY_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::AND, $1, $3, @1.begin.line, @1.begin.column);
    }
    ;
...
EQUALITY_EXPR:
    ...
    | EQUALITY_EXPR EQ RELATIONAL_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::EQ, $1, $3, @1.begin.line, @1.begin.column);
    }
    | EQUALITY_EXPR NE RELATIONAL_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::NEQ, $1, $3, @1.begin.line, @1.begin.column);
    }
    ;
...
RELATIONAL_EXPR:
    ...
    | RELATIONAL_EXPR LE ADDSUB_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::LE, $1, $3, @1.begin.line, @1.begin.column);
    }
    | RELATIONAL_EXPR GE ADDSUB_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::GE, $1, $3, @1.begin.line, @1.begin.column);
    }
    | RELATIONAL_EXPR LT ADDSUB_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::LT, $1, $3, @1.begin.line, @1.begin.column);
    }
    | RELATIONAL_EXPR GT ADDSUB_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::GT, $1, $3, @1.begin.line, @1.begin.column);
    }
    ;
...
MULDIV_EXPR:
    ...
    | MULDIV_EXPR STAR UNARY_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::MUL, $1, $3, @1.begin.line, @1.begin.column);
    }
    | MULDIV_EXPR SLASH UNARY_EXPR {
        $$ = new BinaryExpr(FE::AST::Operator::DIV, $1, $3, @1.begin.line, @1.begin.column);
    }
    ;
